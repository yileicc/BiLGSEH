...
def main():
    ...
    if config.TRAIN == True:
        ...
        excel_dir_path = os.path.join(dir_path, 'excel_pr_covers.xlsx')
...
def set_parameter():
    ...
    parser.add_argument('--DATASET', default='mscoco', help='mirflickr, mscoco, nus-wide', type=str)
    ...
    parser.add_argument('--t', default=0.4, help='temperature', type=float)
    ...
    parser.add_argument('--LR_DIS', default=0.001, type=float, help='0.001')
